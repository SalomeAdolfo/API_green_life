    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                {{ html()->select('categoria_id', $categoria)->placeholder('Selecciona')->class('form-control form-control-sm') }}
            </div>
            <div class="mb-3">
            ...
            <div class="mb3">
                ...
                {{ html()->textArea('imagen')->class('form-control form-control-sm')->attributes(['row' => 0])}}
            </div>
